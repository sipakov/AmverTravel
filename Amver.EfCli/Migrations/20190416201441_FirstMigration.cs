        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleOfCompanionId = table.Column<int>(nullable: true),
                    GenderOfCompanionId = table.Column<int>(nullable: true),
                    Comment = table.Column<string>(nullable: true),
                    CreatedDate = table.Column<DateTime>(nullable: false),
                    IsDeleted = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Trips_Genders_GenderOfCompanionId",
                        column: x => x.GenderOfCompanionId,
                        principalTable: "Genders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Trips_Roles_RoleOfCompanionId",
                        column: x => x.RoleOfCompanionId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    UserOneId = table.Column<int>(nullable: true),
                    UserTwoId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Messages_Users_UserOneId",
                        column: x => x.UserOneId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Messages_Users_UserTwoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trips_GenderOfCompanionId",
                table: "Trips",
                column: "GenderOfCompanionId");

            migrationBuilder.CreateIndex(
                name: "IX_Trips_RoleOfCompanionId",
                table: "Trips",
                column: "RoleOfCompanionId");
